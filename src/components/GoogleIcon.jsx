// BookVerse — Ícone "G" para o botão de login com Google
//
// Desenho simplificado e genérico (não é uma reprodução do asset oficial
// do Google) — apenas a letra "G" com as cores associadas à marca, padrão
// comum em botões de "Continuar com Google" feitos sob medida.
